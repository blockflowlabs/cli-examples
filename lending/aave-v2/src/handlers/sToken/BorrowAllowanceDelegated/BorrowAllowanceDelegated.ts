...
import {
  ...
  IStableTokenDelegatedAllowance,
} from "../../../types/schema";
...
export const BorrowAllowanceDelegatedHandler = async (
  ...
  let delegatedAllowanceId =
    "stable" + fromUser.toString() + toUser.toString() + asset.toString();

  let stabletokendaDB = bind(StableTokenDelegatedAllowance);
  let delegatedAllowance: IStableTokenDelegatedAllowance =

...
/**
 * @dev Event::ReserveUsedAsCollateralEnabled(address reserve, address user)
 * @param context trigger object with contains {event: {reserve ,user }, transaction, block, log}
 * @param bind init function for database wrapper methods
 */
export const ReserveUsedAsCollateralEnabledHandler = async (
  context: IEventContext,
  bind: IBind,
  secrets: ISecrets
) => {
  // Implement your event handler logic for ReserveUsedAsCollateralEnabled here

...
export const TransferHandler = async (
  ...
  let transfer = await transferDB.create({
    ...
    transaction_from_address: transaction.transaction_from_address.toString().toLowerCase(),
    transaction_to_address: transaction.transaction_to_address.toString().toLowerCase(),
